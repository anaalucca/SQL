...
START TRANSACTION; 
INSERT INTO medico_veterinario (id_mv, nome_mv, telefone_mv, email_mv, cpf_mv, crmv, especialidade) 
...
-- A inserção dos dados na tabela medico_veterinario com o id_mv se faz necessária mesmo que ele seja AUTOINCREMENT, pois quando é feito o ROLLBACK os id_mv saem de ordem 
